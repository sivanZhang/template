    ...
    <div>
        <div style="padding-top:10px;">
          <div style="padding-bottom:10px;" v-if="auth">
            <el-button style="margin-left:0;" type="primary" @click="openDialog(2)" size="medium">固定调参</el-button>
            <el-button type="warning" @click="openDialog(3)" size="medium">自动调参</el-button>
            <el-button type="primary" @click="openDialog(1)" size="medium">参量修改</el-button>
            <el-button type="success" @click="openDialog(4)" size="medium">发送实测值</el-button>
            <el-button type="warning" @click="openDialog(5)" :disabled="wellDetail.status" size="medium" v-if="auth"
            >直接指令发送</el-button>
          ...
          >
            ...
            <el-table-column prop="order_type" label="指令类型" :formatter="Order_type" align="center" width="170"></el-table-column>
            <el-table-column prop="text" label="内容" align="center" width="400"></el-table-column>
        ...
        <div class="diag-footer">
          <el-dialog title="参量调整" :visible.sync="dialogVisible1" width="500px">
            <el-form :model="paramModal" ref="paramModal" :rules="rules">
              ...
              <el-form-item label="冲程 (米)" prop="stroke" v-if="wellDetail.well_type ==0">
                  <el-input-number
              ...
              <!-- //泵型跟泵径 -->
              <el-form-item :label="wellPumpType" prop="pumptype" 
              ...
              <el-form-item label="平衡块数量" prop="banlence" placeholder="千瓦" v-if="wellDetail.well_type ==0">
              ...
              <el-form-item label="油管外径尺寸 (毫米)" prop="outer_diameter" placeholder="毫米">
                  <el-input-number v-model="paramModal.outer_diameter" :min="0"  size="medium"></el-input-number>
                  <el-button
                  type="primary"
                  class="buttonConfirm"
              ...
              <el-form-item label="机型" prop="pumping_id" v-if="wellDetail.well_type ==0">
              ...
              <el-form-item label="是否停止周期性自动测产参量" prop="param_cechan" placeholder="千瓦">
                  <el-switch
              ...
              <el-form-item label="更换驱动装置" prop="param_huan_jiansuqi" placeholder="千瓦" v-if="wellDetail.well_type ==1">
                  <el-select v-model="paramModal.param_huan_jiansuqi" placeholder="请选择">
                  <el-option
              ...
              <el-form-item label="1、3平衡块重量（千牛）" prop="param_balance_big_weight" placeholder="千瓦" v-if="wellDetail.well_type ==0">
                  <el-input-number
              ...
              <el-form-item label="2、4平衡块重量（千牛）" prop="param_balance_small_weight" placeholder="千瓦" v-if="wellDetail.well_type ==0">
                  <el-input-number
              ...
              <el-form-item label="平衡块尺寸1 (米)" prop="param_balance_size1" placeholder="千瓦" v-if="wellDetail.well_type ==0">
                  <el-input-number
              ...
              <el-form-item label="平衡块尺寸2 (米)" prop="param_balance_size2" placeholder="千瓦" v-if="wellDetail.well_type ==0">
                  <el-input-number
              ...
              <el-form-item label="平衡块尺寸3 (米)" prop="param_small_balance_size1" placeholder="千瓦" v-if="wellDetail.well_type ==0">
                  <el-input-number
              ...
              <el-form-item label="平衡块尺寸4 (米)" prop="param_small_balance_size2" placeholder="千瓦" v-if="wellDetail.well_type ==0">
                  <el-input-number
              ...
              <el-form-item label="曲柄重量 (千牛)" prop="param_qubing_weight" placeholder="千瓦" v-if="wellDetail.well_type ==0">
                  <el-input-number
              ...
              <el-form-item label="销子重量 (千牛)" prop="param_xiaozi_weight" placeholder="千瓦" v-if="wellDetail.well_type ==0">
                  <el-input-number
              ...
              <el-form-item label="曲柄尺寸 (米)" prop="param_qubing_size" placeholder="千瓦" v-if="wellDetail.well_type ==0">
                  <el-input-number
            ...
            <el-form :model="freguencyModal" ref="freguency-modal" label-width="100px" :rules="rules">
              <span v-if="wellDetail.well_type == 0">
                <el-form-item label="冲次" prop="freguency">
                  <el-input-number v-model="freguencyModal.freguency" :min="0" :precision="1" :step="0.1"></el-input-number>
                </el-form-item>
              </span>
              ...
              <div class="butn">
                  <el-button @click="cancel(2)" style="width:60px;height:30px">取消</el-button>
                  <el-button
                  type="primary"
          ...
          <el-dialog title="自动调参" :visible.sync="dialogVisible3" width="380px">
              <span>确定执行自动调参</span>
              <div class="butn">
              <el-button @click="cancel(3)" style="width:60px;height:30px">取消</el-button>
              <el-button type="primary" @click="autoFreguency()" style="width:60px;height:30px">确认</el-button>
              </div>
          </el-dialog>
          <el-dialog title="发送实测数据" :visible.sync="dialogVisible4" width="500px">
            <el-form :model="readdataBtn" ref="readdata-btn" :rules="rules">
              ...
              <el-form-item label="计量间实测产量值" prop="dataOutput" style="margin-top:60px;">
          ...
          <el-dialog title="指令发送" :visible.sync="dialogVisible5" width="450px">
            <el-form :model="anyOrderModal" ref="any-order-modal" :rules="rules">
              <el-form-item label="十六进制指令" prop="anyOrder">
                  <el-input v-model="anyOrderModal.anyOrder" placeholder="f1 00 0e 05 00 20 00" style="width:300px;"></el-input>
              </el-form-item>
              <div class="butn">
...
export default {
  props:["orderList","total","auth","wellName","number","wellDetail"],
  data() {
    return {
      ...
      // stroke_speed : '',//是冲程还是转速
      pumptypeListChouyou:[//抽油机的泵径列表
        {value:"28"},
        {value:"32"},
        {value:"38"},
        {value:"44"},
  ...
  methods:{
    ...
    selectBlur(e) {
      this.paramModal.pumptype= e.target.value
    },
    getPumping(){
      ...
      switch (Type) {
        case 1:
          ...
          if(this.wellDetail.zhouqixing_cechan != null){
              this.zhouqixing_cechan = this.wellDetail.zhouqixing_cechan==0?false:true
          }else{
          ...
          this.paramModal={
            ...
            pumping_id :this.wellDetail.pumping_type.type_name==null?undefined:this.wellDetail.pumping_type.type_name,
            permanent_magnet_motor_rated_power: this.wellDetail.motor_type==1?this.wellDetail.motor_power:undefined,
            asynchronous_motor_rated_power: this.wellDetail.motor_type==0?this.wellDetail.motor_power:undefined,
            ...
            param_balance_small_weight:this.wellDetail.weight_2_big_balance==null?undefined:this.wellDetail.weight_2_big_balance,
        ...
        case 2:
          ...
          if(this.wellDetail.well_type ==0){
            // 冲程
            this.freguencyModal.freguency = this.wellDetail.impulse_times?this.wellDetail.impulse_times:0
          }else{
            // 转速
            this.freguencyModal.freguency = this.wellDetail.speed?this.wellDetail.speed:0
          } 
          break;    
        case 3:
          // 自动调参
        ...
        case 4:            
          ...
          this.readdataBtn={
            realLevel:this.wellDetail.liquid_level?this.wellDetail.liquid_level:0,
